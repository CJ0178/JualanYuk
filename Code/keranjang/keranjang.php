...
$trollies = query("SELECT t.qty, i.qtyPerItem, i.itemId,i.itemName, i.buyPrice, i.itemImage FROM trolly t JOIN item i ON i.itemId=t.itemId WHERE t.userId=$currentUserId");
// var_dump($trollies);
?>
