...
// Cek apakah ada categoryId di url
if(isset($_GET["categoryId"])){
    $categoryId = $_GET["categoryId"];
    $categoryName = query('SELECT * FROM category WHERE categoryId = '.$categoryId)[0]['categoryName'];
    $items = query("SELECT * FROM item WHERE categoryId = $categoryId");    
} else{
